...
@section('content')
    <h1 class="text-2xl font-bold text-gray-900 mb-1">স্বাগতম!</h1>
    <p class="text-gray-500 text-sm mb-6">আপনার একাউন্টে লগইন করুন</p>
    ...
    <form method="POST" action="{{ route('login.attempt') }}" x-data="{ loading: false }" @submit="loading = true">
        ...
        <button type="submit" :disabled="loading"
                class="btn btn-primary w-full justify-center py-3 text-base relative">
        ...
        <p class="text-center text-sm text-gray-500 mt-4">
            একাউন্ট নেই?
            <a href="{{ route('register') }}" class="text-primary-600 font-medium hover:underline">নিবন্ধন করুন</a>
        </p>
    </form>
@endsection
