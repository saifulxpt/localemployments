    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        @else
            <div class="p-12 text-center">
                ...
                <p class="text-gray-500 mb-6 max-w-md mx-auto">আপনার কোনো বুকিং পাওয়া যায়নি। আপনার প্রয়োজনীয় সার্ভিস পেতে কাজ পোস্ট করুন।</p>
                <a href="{{ route('seeker.job-requests.create') }}" class="btn btn-primary">কাজ পোস্ট করুন</a>
            </div>
        @endif
    </div>
