...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.categories.subcategories.create', $category->id) }}" class="btn btn-primary bg-blue-600 hover:bg-blue-700">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('admin.categories.subcategories.edit', [$category->id, $subcategory->id]) }}" class="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded transition-colors" title="এডিট">
                                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                    </a>
                                    <form action="{{ route('admin.categories.subcategories.destroy', [$category->id, $subcategory->id]) }}" method="POST" class="inline-block" onsubmit="return confirm('আপনি কি নিশ্চিত? এটি মুছে ফেললে এর সাথে যুক্ত কাজগুলোর সমস্যা হতে পারে।')">
                                        @csrf
                                        @method('DELETE')
