    ...
    <div class="container mx-auto px-4 max-w-6xl">
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition-all group">
                <div class="w-14 h-14 rounded-2xl bg-primary-50 text-primary-600 flex items-center justify-center mb-6 group-hover:bg-primary-600 group-hover:text-white transition-all">
            ...
            {{-- Feature 2 --}}
            <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition-all group">
                <div class="w-14 h-14 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center mb-6 group-hover:bg-emerald-600 group-hover:text-white transition-all">
        ...
        <div class="bg-white rounded-3xl p-8 md:p-12 border border-gray-100 shadow-sm mb-16">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                <div class="p-6 bg-primary-50/60 rounded-2xl border border-primary-100/80">
                    <div class="w-12 h-12 bg-primary-600 text-white rounded-xl flex items-center justify-center font-bold text-xl mb-4">🎯</div>
                ...
                <div class="p-6 bg-emerald-50/60 rounded-2xl border border-emerald-100/80">
                    <div class="w-12 h-12 bg-emerald-600 text-white rounded-xl flex items-center justify-center font-bold text-xl mb-4">💼</div>
