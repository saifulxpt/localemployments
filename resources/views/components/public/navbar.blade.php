    ...
    <div class="container mx-auto px-4">
        <div class="flex items-center justify-between h-16">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-2 font-bold text-xl text-primary-700">
                ...
                <span class="hidden sm:block">LocalEmployments</span>
            </a>
            ...
            <div class="flex items-center gap-3">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm font-medium text-gray-600 hover:text-primary-600 transition-colors hidden sm:block">লগইন</a>
                    <a href="{{ route('register') }}" class="btn btn-primary text-sm">নিবন্ধন করুন</a>
                @endauth
    ...
    <div x-show="mobileOpen" x-cloak x-transition class="md:hidden bg-white border-t border-gray-100 px-4 py-3 space-y-1">
        ...
        @guest
            <div class="pt-2 flex gap-2">
                ...
                <a href="{{ route('register') }}" class="btn btn-primary flex-1 text-center text-sm">নিবন্ধন</a>
            </div>
        @endguest
    </div>
</nav>
