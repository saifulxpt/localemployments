    ...
    <div class="hidden lg:flex lg:w-1/2 relative bg-primary-900 text-white overflow-hidden items-center justify-center p-12">
        ...
        <div class="absolute inset-0 z-0 opacity-20">
            <svg class="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
                <pattern id="grid-pattern-register" width="10" height="10" patternUnits="userSpaceOnUse">
                    <circle cx="2" cy="2" r="1.5" fill="white"/>
                </pattern>
                <rect width="100%" height="100%" fill="url(#grid-pattern-register)"/>
            </svg>
        </div>
        <div class="absolute -top-32 -right-32 w-96 h-96 bg-accent-500 rounded-full blur-3xl opacity-40"></div>
        <div class="absolute -bottom-32 -left-32 w-96 h-96 bg-emerald-500 rounded-full blur-3xl opacity-40"></div>
