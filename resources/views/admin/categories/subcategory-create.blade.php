...
@section('title', 'নতুন সাব-ক্যাটাগরি তৈরি')
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4 mb-4">
        ...
        <h1 class="text-2xl font-bold text-gray-900">নতুন সাব-ক্যাটাগরি যোগ করুন</h1>
    </div>
        ...
        <form action="{{ route('admin.categories.subcategories.store', $category->id) }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" class="input w-full" value="{{ old('name') }}" placeholder="যেমন: এসি সার্ভিসিং" required>
                    @error('name') <span class="text-xs text-red-500 mt-1 block">{{ $message }}</span> @enderror
                </div>

                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">বিবরণ (ঐচ্ছিক)</label>
                    <textarea name="description" rows="3" class="input w-full" placeholder="সাব-ক্যাটাগরি সম্পর্কে কিছু লিখুন...">{{ old('description') }}</textarea>
