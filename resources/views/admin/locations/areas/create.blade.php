...
@section('title', 'নতুন এলাকা যোগ করুন')
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4 mb-4">
        ...
        <h1 class="text-2xl font-bold text-gray-900">নতুন উপজেলা/এলাকা যোগ করুন</h1>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8">
        ...
        <form action="{{ route('admin.locations.areas.store', $district) }}" method="POST">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" class="input w-full" value="{{ old('name') }}" required placeholder="e.g. Mirpur">
                    ...
                    <div>
                        ...
                        <input type="text" name="bn_name" class="input w-full" value="{{ old('bn_name') }}" required placeholder="উদাঃ মিরপুর">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" step="any" name="latitude" class="input w-full" value="{{ old('latitude') }}">
                    ...
                    <div>
                        ...
                        <input type="number" step="any" name="longitude" class="input w-full" value="{{ old('longitude') }}">
            ...
            <div class="mt-8 pt-6 border-t border-gray-100 flex gap-4 justify-end">
                ...
                <button type="submit" class="btn btn-primary bg-blue-600 hover:bg-blue-700">সংরক্ষণ করুন</button>
            </div>
        </form>
    </div>
